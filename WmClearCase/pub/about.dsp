...
%comment%
%invoke wm.cc.admin:getUiProperties%%endinvoke%
%end%
<html>
    <head>
    %comment%
        ...
        <link rel="stylesheet" type="text/css" href="/WmClearCase/cc.css"></link>
    %end%
    </head>
    ...
    <p>Geez, it's difficult writing DSPs.</p>
        ...
        %invoke wm.cc.admin:getStartupErrors%
            %scope startupErrors%
                        ...
                        %scope #$key%
                            <tr class="message">
                                <td id="message">
                                    ...
                                    <a href=/invoke/wm.cc.error/getErrorDetail?errorMessage=%value -urlencode $key%>[alternate view]</a>
                                    <br>
                                    %ifvar reason%
        ...
        %invoke wm.cc.admin:getConfiguration%
            %invoke wm.cc.admin.statistic:getStatistics%
                <table width=100%>
                            ...
                            <table class="table2" width=100%>
                                ...
                                <tr>
                                    ...
                                    <td class="oddrowdata" colspan=2>
                                        ...
                                        <a href=/invoke/wm.cc.log/readLogFile?logId=WmSourceSafe>view</a>
                                    </td>
                                </tr>
            ...
            %onerror%
                ...
                %endloop%
                -->
                %include ../../../WmClearCase/pub/error/onerrorTable.dsp%
            %endinvoke%
