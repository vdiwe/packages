--********************************************************************
--
-- Drop script for Trading Networks 6.0 DB2
--
--********************************************************************
...
DROP TABLE BizDocUniqueKeys ;

DROP TABLE BizDocContent ;
DROP TABLE BizDoc ;
DROP TABLE BizDocTypeDef ;

DROP TABLE DeliveryQueue ;

DROP TABLE SecurityAgreement ;
DROP TABLE SecurityData ;

DROP TABLE TPA ;

DROP TABLE Partner ;

DROP TABLE EDITRACKING ;
